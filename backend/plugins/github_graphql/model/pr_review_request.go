...
// GithubPrReviewRequest stores all requested reviewers for a PR,
// regardless of whether they actually submitted a review.
...
func (GithubPrReviewRequest) TableName() string {
